...
//@FeignClient(name = "LEAGUE-MICROSERVICE", fallback = LeaFallBack.class)
...
public interface APIClient {
    ...
    @GetMapping("api/leagues/{league-code}")
    LeagueDto getLeaByCode(@PathVariable("league-code") String leagueCode);
}
